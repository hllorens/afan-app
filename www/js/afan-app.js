...
if(is_cordova()){backend_url='http://www.centroafan.com/afan-app/www/backend/';}
...
if(navigator.onLine){ // or use this request to determine if this is online...
    ajax_request(backend_url+'ajaxdb.php?action=gen_session_state',function(text) {
...
function invitee_access(){
    ...
    ajax_request_json(
        ...
        function(invitado_data) {
            ...
            cache_user_summary_view=invitado_data.cache_user_summary_view;
            menu_screen();
        });*/
